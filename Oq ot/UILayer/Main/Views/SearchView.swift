...
class SearchView: UIView {
    ...
    lazy var textField: CustomTextField = {
        ...
        tf.textColor = UIColor.init(hex: "#B5B5B5")
        tf.layer.borderWidth = 0
        tf.backgroundColor = .clear
        tf.attributedPlaceholder = NSAttributedString.getAttrTextWith(13, "search".translate(), false, UIColor.init(hex: "#B5B5B5"), .left)
    ...
    private func setupView() {
        ...
        textField.anchor(top: topAnchor, leading: leadingAnchor, bottom: bottomAnchor, trailing: trailingAnchor, padding: UIEdgeInsets(top: 4, left: 20, bottom: 4, right: 80))
        ...
        clearImageView.anchor(top: nil, leading: nil, bottom: nil, trailing: imageV.leadingAnchor, padding: UIEdgeInsets(top: 0, left: 0, bottom: 0, right: 20), size: CGSize(width: 20, height: 20))
