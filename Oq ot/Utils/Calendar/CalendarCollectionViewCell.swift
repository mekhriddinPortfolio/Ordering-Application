...
class CalendarCollectionViewCell: UICollectionViewCell {
    ...
    var selectionBackgroundView: UIView = {
        ...
        view.layer.cornerRadius = 9 * RatioCoeff.width
        return view
    }()
    ...
    lazy var monthLabel: UILabel = {
        ...
        label.text = "1"
        label.font = UIFont.systemFont(ofSize: 13 * RatioCoeff.width)
    ...
    private func configure(){
        ...
        NSLayoutConstraint.activate([
            ...
            selectionBackgroundView.widthAnchor.constraint(equalToConstant: 26 * RatioCoeff.width),
