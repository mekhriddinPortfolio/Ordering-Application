...
class AvatarViewController: UIViewController, UIViewControllerTransitioningDelegate {
    ...
    lazy var uploadPhotoView: UIView = {
        let  view = UIView()
        view.layer.cornerRadius = 40
        view.backgroundColor = UIColor.init(hex: "#DE8706")
    ...
    let saveButton = CustomButton(buttonTitle: "Сохранить", backgroundColor: UIColor.init(hex: "#DE8706"), cornerRadius: 8)
    ...
    private func configure() {
        ...
        titleLabel.anchor(top: topLine.bottomAnchor, leading: slideUpView.leadingAnchor, bottom: nil, trailing: slideUpView.trailingAnchor, padding: UIEdgeInsets(top: 20, left: 16, bottom: 0, right: 16), size: CGSize(width: 0, height: 24))
        separatorLine.anchor(top: titleLabel.bottomAnchor, leading: slideUpView.leadingAnchor, bottom: nil, trailing: slideUpView.trailingAnchor, padding: UIEdgeInsets(top: 15, left: 16, bottom: 0, right: 16), size: CGSize(width: 0, height: 1))
        bodyLabel.anchor(top: separatorLine.bottomAnchor, leading: slideUpView.leadingAnchor, bottom: nil, trailing: slideUpView.trailingAnchor, padding: UIEdgeInsets(top: 15, left: 16, bottom: 0, right: 16), size: CGSize(width: 0, height: 54))
        uploadPhotoView.anchor(top: bodyLabel.bottomAnchor, leading: nil, bottom: nil, trailing: nil, padding: UIEdgeInsets(top: 15, left: 0, bottom: 0, right: 0), size: CGSize(width: 80, height: 80))
